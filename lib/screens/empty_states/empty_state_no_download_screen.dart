...
class EmptyStateNoDownloadScreen extends ConsumerWidget {
  const EmptyStateNoDownloadScreen({Key? key}) : super(key: key);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Files and media you\'ve downloaded for offline access will appear here, encrypted and secure.',
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildNavItem(Icons.download_outlined, 'DOWNLOADS', isDark, true),
